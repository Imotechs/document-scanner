    ...
    const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                ...
                img.onload = () => {
                    const canvas = canvasRef.current;
                    setImageSize({ width: img.width*0.6, height: img.height*0.6 });
    ...
    return (
        ...
        >
          ...
          />
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-[12px]">{`Choose an Image|Drag and Drop Image`}</span>
                            </div>
                        </div>
                    </div>
                )}
      ...
      /> </>}
            ...
            <div className=" rounded-[30px] mt-0 mb-5  bottom-0 p-5 items-center justify-center space-x-5 bg-gray-700 mx-auto max-w-max">
                        ...
                        <UploadOutlined  title="Insert Image" onClick={()=>handleImageUpload()} className="bg-blue-500 text-black px-4 py-2 rounded" />
