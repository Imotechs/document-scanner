...
export const DocumentScanner = forwardRef((props:any, ref:any) => {
    const [isFileSelected, setIsFileSelected] = useState(false);
    const [cornerPoints, setCornerPoints] = useState<Point[]>([]);

    const internalFileInputRef = useRef(null);
    const internalCanvasRef = useRef(null);
    const fileInputRef = props.fileInputRef || internalFileInputRef;
    ...
    useImperativeHandle(ref, () => ({
        scanImage: onHandleScanImage,
        cropImage:onHandleCropImage,
      }));
