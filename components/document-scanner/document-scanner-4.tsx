    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-100">
            ...
            <header className="bg-white shadow p-6">
                ...
                {/* <p className="text-sm text-gray-500 mt-1">OpenCV status - {isOpencvLoaded ? "Loaded" : "Not loaded"}</p> */}
            </header>

            <div className="flex-grow flex flex-col items-center justify-center p-6">
                {
                    !isOpencvLoaded ?
                        <div className="h-64 w-64 max-w-2xl relative border-2 border-neutral-300 shadow rounded-lg">
                ...
                {!isFileSelected && isOpencvLoaded && (
                    <div className="h-96 w-full max-w-2xl relative border-2 border-gray-300 border-dashed rounded-lg">
                        ...
                        <div className="h-full w-full bg-gray-100 absolute z-1 flex justify-center items-center top-0 rounded-lg">
                            <div className="flex flex-col items-center">
                ...
                {isFileSelected && isOpencvLoaded && (
                    ...
                    >
                        ...
                        {circles.map((circle, index) => (
                            <Draggable
                                key={index}
                                position={{ x: circle.x - circle.radius, y: circle.y - circle.radius }}
            ...
            {/* Footer */}
            <footer className="flex justify-end bg-white p-6 border-t space-x-4">
                <button
